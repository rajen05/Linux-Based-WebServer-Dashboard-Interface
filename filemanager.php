            ...
            case 'get_tree':
                ...
                if (DIRECTORY_SEPARATOR === '\\\\') {
                    ...
                    for ($l = 'A'; $l <= 'Z'; $l++) {
                        $drive = $l . ':\\\\';
                        if (is_dir($drive)) {
                            $drives[] = array('name'=>$l.':','path'=>$drive,'children'=>array(),'hasChildren'=>true);
                        }
                    }
