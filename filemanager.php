                ...
                if ($items !== false) {
                    foreach ($items as $i) {
                        ...
                        if (is_dir($f)) {
                            ...
                            $children[] = array('name'=>$i,'path'=>$f,'children'=>array(),'hasChildren'=>$hasChildren);
                        }
                    }
                    usort($children, function($a,$b){ return strcasecmp($a['name'],$b['name']); });
                }
                $res = array('success'=>true,'children'=>$children);
                break;
        }
